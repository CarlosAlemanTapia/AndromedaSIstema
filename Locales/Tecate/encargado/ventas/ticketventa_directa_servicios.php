...
<body onload="imprimir()">
	...
	<?php
		...
		$sentencia = $base_de_datos->query("SELECT * FROM venta_servicios WHERE id_servicios = (SELECT max(id_servicios) FROM venta_servicios where sucursal = 'Tecate'); ");
	...
	?>
            ...
            <img
                ...
                <p style="margin-left: 5px;" class="centrado"><h2>Numero: 665 201 0949</h2></p>
