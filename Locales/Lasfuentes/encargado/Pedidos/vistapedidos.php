				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Lista De Pedidos</h2>
						...
						<!-- 	<a style="margin-left: 50%;" class="btn btn-success" href="./formulario.php">Nuevo Producto <i class="fa fa-plus"></i></a> -->
							<a style="margin-left: 70%;" class="btn btn-success" href="crearnuevopedido.php">Crear Nueva Pedido</a>
						</div>
					</div>
				</div>
									...
									<table class="table table-hover" >
										...
										<tbody>
											...
											<tr>
												...
												<td><a class="btn btn-warning" href="<?php echo "modificarpedido.php?id_pedido=" . $producto->id_pedido?>"><i class="fas fa-edit"></i></a></td>
