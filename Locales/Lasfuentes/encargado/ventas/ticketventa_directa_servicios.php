...
// $sentencia = $base_de_datos->prepare("SELECT * FROM productos_vendidos WHERE id_productos_vendidos = (SELECT max(id_productos_vendidos) FROM productos_vendidos) and sucursal_vendido = 'La Joya' ;");
// $sentencia->execute();
...
<body onload="imprimir()">
	...
	<?php
		...
		$sentencia = $base_de_datos->query("SELECT * FROM venta_servicios WHERE id_servicios = (SELECT max(id_servicios) FROM venta_servicios where sucursal = 'Las fuentes'); ");
	...
	?>
            ...
            <img
                ...
                <p style="margin-left: 5px;" class="centrado"><h2>Numero: 664 505 04 51</h2></p>
    ...
    <div style="width: 150px; height: 50px; margin-left: 400px; margin-top: -350px;">
    	...
    	<br>
    	<br>
    	<a class="btn btn-danger" href="vistaventasjoya.php">Regresar  <i class="fas fa-chevron-left"></i></a>
    </div>
