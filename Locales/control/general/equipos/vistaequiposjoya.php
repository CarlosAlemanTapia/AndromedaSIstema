					...
					<div class="row mt--2">
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title"><b>Lista De Equipos Android La Joya</b> </div>
									<br>
							...
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title"><b>Lista De Equipos Apple La Joya</b> </div>

												<?php
					include_once "../../../base_de_datos.php";
					$sentencia2 = $base_de_datos->query("SELECT * FROM equipos where status <> 'Entregado' and marca = 'Apple' and sucursal = 'La Joya' order by numero_nota desc ;");
