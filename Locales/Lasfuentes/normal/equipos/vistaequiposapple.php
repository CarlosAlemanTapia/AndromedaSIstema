					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									<li>
										<a href="./vistaequiposandroid.php">
											<span class="sub-item">Android</span>
										</a>
									</li>
									<li>
										<a href="./vistaequiposapple.php">
		...
		<div class="main-panel">
			<div class="content">
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Equipos APPLE</h2>
						...
						<!-- 	<a style="margin-left: 50%;" class="btn btn-success" href="./formulario.php">Nuevo Producto <i class="fa fa-plus"></i></a> -->
							<a style="margin-left: 70%;" class="btn btn-success" href="crearequiposapple.php">Crear Nueva Nota</a>
						</div>
					</div>
				</div>
				...
				<?php
					...
					$sentencia = $base_de_datos->query("SELECT * FROM equipos where status <> 'Entregado' and marca = 'Apple' and sucursal = 'Las fuentes' order by numero_nota desc ;");
					...
					<div class="row mt--2">
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title"><b>Lista De Equipos</b> </div>
									<br>
									...
									<table class="table table-hover" >
										...
										<tbody>
											...
											<tr>
												...
												<td><a class="btn btn-info" href="<?php echo "notasapple.php?numero_nota=" . $producto->numero_nota?>"><i class="fas fa-notes-medical"></i></a></td>
												<td><a class="btn btn-warning" href="<?php echo "modificarnotaapple.php?numero_nota=" . $producto->numero_nota?>"><i class="fas fa-notes-medical"></i></a></td>
												<td><a class="btn btn-danger" href="<?php echo "eliminarnotaapple.php?numero_nota=" . $producto->numero_nota?>"><i class="fas fa-notes-medical"></i></a></td>
