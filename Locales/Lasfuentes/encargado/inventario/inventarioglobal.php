		...
		<div class="main-panel">
			<div class="content">
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Inventario Global De Sucursales</h2>
				...
				<?php
					...
					$sentencia = $base_de_datos->query("SELECT * FROM productos order by sucursal_pro;");
					...
					<div class="row mt--2">
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title"><b>BUSCA LOS PRODUCTOS</b> </div>
									<br>
									...
									<table class="table table-hover" id="example">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo $producto->sucursal_pro ?></td>
