...
<body onload="imprimir()">
	...
	<?php
		...
		$sentencia = $base_de_datos->query("SELECT * FROM venta_servicios WHERE id_servicios = (SELECT max(id_servicios) FROM venta_servicios where sucursal = 'Real'); ");
	...
	?>
            ...
            <img
                ...
                <p style="margin-left: 5px;" class="centrado"><h2>Numero: 664 328 6860</h2></p>
