				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Equipos ANDROID y OTROS</h2>
						...
						<!-- 	<a style="margin-left: 50%;" class="btn btn-success" href="./formulario.php">Nuevo Producto <i class="fa fa-plus"></i></a> -->
							<a style="margin-left: 70%;" class="btn btn-success" href="crearequiposandroid.php">Crear Nueva Nota</a>
						</div>
					</div>
				</div>
									...
									<table class="table table-hover" >
										...
										<tbody>
											...
											<tr>
												...
												<td><a class="btn btn-warning" href="<?php echo "modificarnotaandroid.php?numero_nota=" . $producto->numero_nota?>"><i class="fas fa-notes-medical"></i></a></td>
												<td><a class="btn btn-danger" href="<?php echo "eliminarnotaandroid.php?numero_nota=" . $producto->numero_nota?>"><i class="fas fa-notes-medical"></i></a></td>
