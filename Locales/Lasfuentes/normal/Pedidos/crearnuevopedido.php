				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Agregar Un Nuevo Pedido</h2>
								...
								<div class="card-body">
											...
											<form method="post" action="crearpedido.php">
								                ...
								                <option value="HP">HP</option>
													...
													<div class="form-group form-group-default">
														<label>Dejo Equipo:</label>
															 <select name="dejo_equipo" id="dejo_equipo" class="form-group form-group-default">
								                ...
								                <option value="No">NO</option>
													...
													<input type="hidden" id="sucursal" name="sucursal" value="Las fuentes">
