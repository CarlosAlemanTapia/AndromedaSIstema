		...
		<div class="main-panel">
			<div class="content">
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Lista De Productos En Inventario</h2>
								<h5 class="text-white op-7 mb-2">Andromeda Reparaciones</h5>
							</div>
							<a style="margin-left: 50%;" class="btn btn-success" href="./formulario.php">Nuevo Producto <i class="fa fa-plus"></i></a>
							<a style="margin-left: 10px;" class="btn btn-success" href="pdf.php">Exportar Productos Que Llegaron Hoy</a>
						</div>
					</div>
				</div>
				...
				<?php
					...
					$sentencia = $base_de_datos->query("SELECT * FROM productos where sucursal_pro = 'Las fuentes' ;");
					...
					<div class="row mt--2">
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title"><b>PRODUCTOS</b> </div>
									<br>
									...
									<table class="table table-hover" id="example">
										...
										<tbody>
											...
											<tr>
												...
												<td><a class="btn btn-success" href=""onClick="window.open('<?php echo "agregarstock.php?id_productos=" . $producto->id_productos?>&usuario=<?= $user['nombre_us']; ?>','popup', 'width=400px,height=400px')"><i class="fas fa-plus-circle"></i></a></td>
												<td><a class="btn btn-warning" href="<?php echo "editar.php?id_productos=" . $producto->id_productos?>"><i class="fa fa-edit"></i></a></td>
												<td><a class="btn btn-danger" href="<?php echo "eliminar.php?id_productos=" . $producto->id_productos?>"><i class="fa fa-trash"></i></a></td>
											</tr>
											<?php } ?>
