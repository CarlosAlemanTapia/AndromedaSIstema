					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									<li>
										<a href="equipos/vistaequiposjoya.php">
											<span class="sub-item">La Joya</span>
										</a>
									</li>
									<li>
										<a href="equipos/vistaequiposlasbrisas.php">
											<span class="sub-item">Las Brisas</span>
										</a>
									</li>
									<li>
										<a href="equipos/vistaequiposlasfuentes.php">
											<span class="sub-item">Las Fuentes</span>
										</a>
									</li>
									<li>
										<a href="equipos/vistaequipostecate.php">
											<span class="sub-item">Tecate</span>
										</a>
									</li>
									<li>
										<a href="equipos/vistaequiposreal.php">
											<span class="sub-item">Real SFC</span>
										</a>
									</li>
								</ul>
			...
			<div class="content">
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Partes por terminar</h5>
							</div>
					...
					<div class="row mt--2">
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
								<p align="center">La Joya</p>
									<?php
					include_once "../../base_de_datos.php";
					$sentencia = $base_de_datos->query("SELECT * FROM productos where sucursal_pro = 'La Joya' and existencia <= 5  ;");
				...
				?>
									...
									<table class="table table-hover" id="example">
										...
										<tbody>
											...
											<tr>
												...
												<td style="background-color: <?php echo $color; ?>; color: black;"><?php echo $producto->existencia ?></td>
						...
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
									<p align="center">Las Fuentes</p>
									<?php
					include_once "../../base_de_datos.php";
					$sentencia = $base_de_datos->query("SELECT * FROM productos where sucursal_pro = 'Las fuentes' and existencia <= 5  ;");
					$productos = $sentencia->fetchAll(PDO::FETCH_OBJ);
				?>
						...
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
									<p align="center">Las Brisas</p>
									<?php
					include_once "../../base_de_datos.php";
					$sentencia = $base_de_datos->query("SELECT * FROM productos where sucursal_pro = 'Las brisas' and existencia <= 5  ;");
					$productos = $sentencia->fetchAll(PDO::FETCH_OBJ);
				?>
						...
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
									<p align="center">Tecate</p>
									<?php
					include_once "../../base_de_datos.php";
					$sentencia = $base_de_datos->query("SELECT * FROM productos where sucursal_pro = 'Tecate' and existencia <= 5  ;");
					$productos = $sentencia->fetchAll(PDO::FETCH_OBJ);
				?>
						...
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
									<p align="center">Real San Francisco</p>
									<?php
					include_once "../../base_de_datos.php";
					$sentencia = $base_de_datos->query("SELECT * FROM productos where sucursal_pro = 'Real' and existencia <= 5  ;");
					$productos = $sentencia->fetchAll(PDO::FETCH_OBJ);
				?>
