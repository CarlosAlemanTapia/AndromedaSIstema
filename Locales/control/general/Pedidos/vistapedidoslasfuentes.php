						...
						<li class="nav-item">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									<li>
										<a href="./vistapedidoslajoya.php">
											<span class="sub-item">La Joya</span>
										</a>
									</li>
									<li>
										<a href="./vistapedidoslasfuentes.php">
											<span class="sub-item">Las Fuentes</span>
										</a>
									</li>
									<li>
										<a href="./vistapedidoslasbrisas.php">
											<span class="sub-item">Las Brisas</span>
										</a>
									</li>

									<li>
										<a href="./vistapedidostecate.php">
											<span class="sub-item">Tecate</span>
										</a>
									</li>

									<li>
										<a href="./vistapedidosreal.php">
		...
		<div class="main-panel">
			<div class="content">
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Lista De Pedidos Las Fuentes</h2>
				...
				<?php
					...
					$sentencia = $base_de_datos->query("SELECT * FROM pedidos where status <> 'Parte en el local' and sucursal = 'Las fuentes' order by id_pedido desc ;");
									...
									<table class="table table-hover" >
										...
										<tbody>
											...
											<tr>
												...
												<td><a class="btn btn-info" href="<?php echo "notapedido.php?id_pedido=" . $producto->id_pedido?>"><i class="fas fa-notes-medical"></i></a></td>
