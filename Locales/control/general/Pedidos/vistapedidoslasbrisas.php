		...
		<div class="main-panel">
			<div class="content">
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Lista De Pedidos Las Brisas</h2>
				...
				<?php
					...
					$sentencia = $base_de_datos->query("SELECT * FROM pedidos where status <> 'Parte en el local' and sucursal = 'Las brisas' order by id_pedido desc ;");
